...
The **Decode Text** block allows you to decode text from various different formats into standard readable text. Decoding is required when a service (such as an external API) provides an encoded form of text that you need to decode and use in your endpoint.

![Screenshot of the Decode Text action block](/images/Screenshot2026-01-28at7.13.19PM.png)
...
![Screenshot of reference variable settings](/images/Screenshot2026-01-28at7.14.05PM.png)
